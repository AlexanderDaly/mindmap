...
export function NodeWrapper({ type, selected, children }: NodeWrapperProps) {
  const colors = NODE_COLORS[type];

  return (
    <div
      className="rounded-2xl px-5 py-3 min-w-[140px] max-w-[260px] text-center transition-all duration-200"
      style={{
